// Grab professor names from LBCC class schedule detail page

var JSSoup = require('jssoup').default;
// var soup = new JSSoup(document.body);
var soup = new JSSoup(`<body><div id="header">
 ...
 </div><div  id="cf_window23106410383434603" class="x-hidden">
...
// Grab all <a> tags from body
allLinks = soup.findAll('a');
// Create array for professor phonebook profile links
phonebookLinks = [];
// Iterate through all links in body
for (var i = 0; i < allLinks.length; i++) {
  link = phonebookLinks[i].attrs.href;
  if (link.startsWith('https://phonebook.lbcc.edu/phonedir/') && !phonebookLinks.include(link)) {
    phonebookLinks.push(link);
  }
}
